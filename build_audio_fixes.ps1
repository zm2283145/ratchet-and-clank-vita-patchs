...
try {
    & "$toolbin\arm-vita-eabi-gcc.exe" -std=gnu11 -O2 -Wall -Wextra -Werror -fno-strict-aliasing -nostdlib '-Wl,-e,module_start' '-Wl,-q' -o rc1_audio_fixes.elf rc1_combined_fixes.c -ltaihen_stub -lSceFios2_stub_weak -lSceLibc_stub_weak -lSceLibKernel_stub_weak -lSceKernelModulemgr_stub -lSceKernelThreadMgr_stub -lSceIofilemgr_stub -lSceCtrl_stub -lgcc
