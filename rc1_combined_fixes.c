 ...
 *
 * Keep the proven music/looping-audio fixes, FMV aspect corrections, and
 * collection-wide loose-file overlays in their own translation units, but
 * expose one taiHEN module so they are loaded and stopped together from a
 * single config entry.
 */
