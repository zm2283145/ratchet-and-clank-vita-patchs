...
namespace LibReplanetizer.LevelObjects
{
    ...
    public class TerrainFragment : ModelObject
    {
        ...
        public override byte[] ToByteArray()
        {
            ...
            // This legacy flag is already stored in little-endian byte order
            // in the PS3 source and is preserved verbatim by the Vita port.
            WriteUshort(head, 0x20, WritingLittleEndian
                ? System.Buffers.Binary.BinaryPrimitives.ReverseEndianness(off20)
                : off20);
