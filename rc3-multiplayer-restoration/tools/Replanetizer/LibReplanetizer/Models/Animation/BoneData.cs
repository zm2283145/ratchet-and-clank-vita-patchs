...
namespace LibReplanetizer.Models.Animations
{
    public class BoneData
    {
        ...
        public byte[] Serialize(bool vita = false)
        {
            ...
            if (vita)
            {
                // Vita reverses the two trailing 16-bit fields used by the
                // PS2/PS3 layout: parent comes before the unknown flag.
                WriteShort(outBytes, 0x0C, (short) (parent * 0x40));
                WriteShort(outBytes, 0x0E, unk0x0C);
            }
            else
            {
